...
ALTER TABLE HASH_ALGO_NAME RENAME TO HASH_ALGO_DETAILS;
CREATE TABLE CRYPTO(
    NAME VARCHAR(200) NOT NULL ,
    SYMBOL VARCHAR(10),
...
ALTER TABLE CRYPTO DROP CONSTRAINT CRYPTO_TABLE_FK_HASH_ALGO_NAME_FK1;
ALTER TABLE CRYPTO ADD CONSTRAINT CRYPTO_TABLE_FK_HASH_ALGO_NAME_FK1 FOREIGN KEY (HASH_ALGO_NAME) REFERENCES ;

-- Insert Data Start

-- Insert Data End

SELECT CONSENSUS_ALGORITHM_TYPE FROM CRYPTO;
